...
inputDir = r'/home/utkarsh/Acads/KOHEtching/3.0%KOH/D08/7G_20150716'
inputFile = r'/home/utkarsh/Acads/KOHEtching/3.0%KOH/D08/7G_20150716/7G_20150716.tif'
...
#for key in seg.dict.keys():
	#for frame in frameList:
			...
			##bImg = ndimage.binary_erosion(bImg,iterations=2)
			#bImg = myCythonFunc.areaThreshold(bImg.astype('uint8'), areaRange=areaRange)
...
#keepList = range(1,36)+[37,40,41,42,43,44,45,47,49,50,51,52,55,56,62]
#removeList = []
